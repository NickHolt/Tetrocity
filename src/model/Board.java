 ...
 * pieces currently in play. This includes the dead Tetriminoes, the live
 * Tetrimino, the stored Tetrimino, and the queued Tetriminoes. Board dimensions 
 * must be provided on instantiation. 
 * 
 ...
 * appropriately. For example, if a Game calls clearRows() on the Board, it will
 ...
 * game {@link Engine}, which can then determine how to update the score. 
 * 
 * @author Nick Holt
 *
 */
public class Board extends JPanel{
    ...
    /**************************************/
    /* Tetrimino coordinate manipulation. */
    /**************************************/
    ...
    public void shiftTetrimino(Direction shiftDirection) {
        shiftTetrimino(getBottomLiveTetrimino(), shiftDirection);
    }
    ...
    public void shiftTetrimino(Tetrimino tetrimino, Direction shiftDirection) {
        ...
        if (tetrimino != null) {
            ...
            if (shiftFailed && shiftDirection == Direction.SOUTH) {
                killTetrimino(tetrimino); //kill the Tetrimino
            } else if (!shiftFailed) {
    ...
    /***********************************/
    /* Queue and storage manipulation. */
    /***********************************/
    ...
    /*************************************/
    /* Miscellaneous state manipulation. */
    /*************************************/
    ...
    /**
     * @return The Tetrimino currently in storage.
     */
    ...
    /**
     * @return The SidePanel containing the queue and storage GUI information.
     */
    ...
    /**
     * @return The height, in pixels, of one grid space.
     */
    ...
    /**
     * @return The width, in pixels, of one grid space.
     */
    private float squareWidth() {
        return (float) getWidth() / (float) mGrid[0].length;
    }
    
    /** Paint the Tetriminoes, grid, and projection shadow.
     */
     ...
     * given ID. The color will be determined solely by the ID. 
     */
    ...
    /** Draws an opaque, grey square at the provided coordinates. This square
     * represents a single block of a Tetrimino projection shadow.
     */
    ...
    public class SidePanel extends JPanel{
        ...
        /** Set all elements of this SidePanel's storage segment to -1.
         */
        ...
        /** Updates this SidePanel's grid with the current queued pieces.
         */
        ...
        /** Set all elements of this SidePanel's queue segment to -1.
         */
        ...
        /**
         * @return The matrix representing the side grid element information.
         */
        public int[][] getSideGrid() {
            return mSideGrid;
        }

        /** Returns a string object representing the state of this SidePanel.
         */
        public String toString() {
            StringBuffer result = new StringBuffer();
        ...
        /** Paint the Tetriminoes, and grid.
         */
        public void paint(Graphics g) {
            super.paint(g);
            drawGrid(g);
        ...
        /** Draws a square representing a single block of a Tetrimino with the
         * given ID. The color will be determined solely by the ID, and will
         * be equivalent to that which it would be if it were painted on the
         * main Board.
         */
        private void drawSquare(Graphics g, float x, float y, int tetriminoID) {
            Color color;
